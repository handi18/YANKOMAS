...
unset($__errorArgs, $__bag); ?>" 
                           id="nama" name="nama" value="<?php echo e(old('nama', $user->nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                           id="nip" name="nip" value="<?php echo e(old('nip', $user->nip)); ?>" required>
                    <?php $__errorArgs = ['nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\kuliah\Magang\projek magang\simaspirasi-imigrasi\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>