                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $aspirasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('aspirasi.show', $item->id)); ?>" class="btn btn-info btn-xs" title="Lihat"><i class="fas fa-eye"></i></a>
                                <?php if(Auth::user()->isAdmin() || Auth::user()->id === $item->petugas_id): ?>
                                    <a href="<?php echo e(route('aspirasi.edit', $item->id)); ?>" class="btn btn-warning btn-xs" title="Edit"><i class="fas fa-edit"></i></a>
                                <?php endif; ?>
