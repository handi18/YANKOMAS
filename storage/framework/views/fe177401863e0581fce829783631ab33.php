...
<body>
                ...
                <div class="glass-container">
                    ...
                    <div class="hero-section">
                        <div class="d-flex justify-content-center gap-4 align-items-center">
                            <img src="<?php echo e(asset('assets/img/logo_imigrasi_RI.png')); ?>" alt="Logo Imigrasi">
                            <img src="<?php echo e(asset('assets/img/logo_imigrasi_Bandung.png')); ?>" alt="Logo Imigrasi Bandung">
                        </div>
                    ...
                    <ul class="nav nav-tabs justify-content-center" id="yankomasTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php echo e($searchPerformed ? '' : 'active'); ?>" id="lapor-tab" data-bs-toggle="tab" data-bs-target="#lapor" type="button" role="tab">
                                <i class="fas fa-edit me-2"></i> Buat Laporan
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php echo e($searchPerformed ? 'active' : ''); ?>" id="status-tab" data-bs-toggle="tab" data-bs-target="#status" type="button" role="tab">
                    ...
                    <div class="tab-content" id="yankomasTabsContent">
                        ...
                        <!-- TAB: LAPOR -->
                        <div class="tab-pane fade <?php echo e($searchPerformed ? '' : 'show active'); ?>" id="lapor" role="tabpanel">
                            ...
                            <form action="<?php echo e(route('public.store')); ?>" method="POST">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control" name="jam_kejadian" value="<?php echo e(old('jam_kejadian', date('H:i'))); ?>" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="layanan_id" id="layanan_id" required>
                                            ...
                                            <?php $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($l->id); ?>" <?php echo e(old('layanan_id') == $l->id ? 'selected' : ''); ?>><?php echo e($l->nama_layanan); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" name="isi_aspirasi" rows="4" placeholder="Ceritakan secara detail terkait saran, informasi, atau pengaduan Anda..." required><?php echo e(old('isi_aspirasi')); ?></textarea>
                                    </div>
                                </div>
                        ...
                        <!-- TAB: CEK STATUS -->
                        <div class="tab-pane fade <?php echo e($searchPerformed ? 'show active' : ''); ?>" id="status" role="tabpanel">
                            ...
                            <form action="<?php echo e(route('home')); ?>" method="GET" class="mb-4">
                                <div class="input-group input-group-lg">
                                    <input type="text" class="form-control" name="tiket" value="<?php echo e($tiket_query); ?>" placeholder="Masukkan Nomor Tiket (cth: ASP-2026...)" required>
                            ...
                            <?php if($searchPerformed): ?>
                                <?php if($aspirasiChecked): ?>
                                    <div class="ticket-result">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="mb-0 fw-bold"><?php echo e($aspirasiChecked->nomor_tiket); ?></h4>
                                            
                                            <?php if($aspirasiChecked->status == 'Baru'): ?>
                                                <span class="status-badge status-baru"><i class="fas fa-inbox me-1"></i> Diterima</span>
                                            <?php elseif($aspirasiChecked->status == 'Diproses'): ?>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <p class="fw-medium"><?php echo e($aspirasiChecked->created_at->format('d F Y')); ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-1 text-white-50">Jenis Laporan</p>
                                                <p class="fw-medium text-capitalize"><?php echo e($aspirasiChecked->jenis == 'pengaduan' && $aspirasiChecked->jenis_custom ? $aspirasiChecked->jenis_custom : $aspirasiChecked->jenis); ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-1 text-white-50">Layanan Terkait</p>
                                                <p class="fw-medium"><?php echo e($aspirasiChecked->layanan ? $aspirasiChecked->layanan->nama_layanan : $aspirasiChecked->layanan_custom); ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-1 text-white-50">Petugas Penanggung Jawab</p>
                                                <p class="fw-medium"><?php echo e($aspirasiChecked->petugas ? $aspirasiChecked->petugas->nama : 'Menunggu Penugasan'); ?></p>
                                            </div>
                                        </div>
                                        
                                        <hr style="border-color: rgba(255,255,255,0.2);">
                                        <p class="mb-1 text-white-50">Isi Laporan:</p>
                                        <p class="fst-italic">"<?php echo e($aspirasiChecked->isi_aspirasi); ?>"</p>
                                    </div>
                                <?php else: ?>
                                    <div class="alert alert-warning text-center" style="background: rgba(255, 193, 7, 0.2); border: 1px solid rgba(255, 193, 7, 0.5); color: #ffe69c;">
                                        ...
                                        Nomor tiket <strong><?php echo e($tiket_query); ?></strong> tidak ditemukan. Pastikan Anda memasukkan nomor tiket yang benar.
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
    ...
    <script>
        ...
        <?php if(session('success_ticket')): ?>
            // Simpan ke localStorage secara otomatis
            localStorage.setItem('yankomas_last_ticket', '<?php echo e(session('success_ticket')); ?>');
            
            Swal.fire({
                title: 'Berhasil Dikirim!',
                html: 'Laporan Anda telah diterima.<br><br>Mohon simpan/salin Nomor Tiket Anda:<br><strong style="font-size: 28px; color: #0066cc; display: block; margin: 15px 0;"><?php echo e(session('success_ticket')); ?></strong>',
                icon: 'success',
                ...
                if (result.isConfirmed) {
                    navigator.clipboard.writeText('<?php echo e(session('success_ticket')); ?>');
                    Swal.fire({
                        title: 'Tersalin!',
                        text: 'Nomor tiket <?php echo e(session('success_ticket')); ?> berhasil disalin ke clipboard.',
                        icon: 'success',
                        timer: 2000,
...
<?php /**PATH C:\laragon\www\simaspirasi-imigrasi\resources\views/public/landing.blade.php ENDPATH**/ ?>