...
<body>
                            ...
                            <?php if($searchPerformed): ?>
                                <?php if($aspirasiChecked): ?>
                                    <div class="ticket-result">
                                        ...
                                        <?php if($aspirasiChecked->jawaban): ?>
                                            <div class="mt-4 p-3 rounded" style="background: rgba(40, 167, 69, 0.1); border-left: 4px solid #28a745;">
                                                ...
                                                <p class="mb-0" style="white-space: pre-wrap;"><?php echo e($aspirasiChecked->jawaban); ?></p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
    ...
    <script>
        ...
        <?php if(session('success_ticket')): ?>
            ...
            var newTicket = '<?php echo e(session('success_ticket')); ?>';
