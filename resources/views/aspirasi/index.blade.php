                ...
                <tbody>
                    @forelse($aspirasi as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('aspirasi.show', $item->id) }}" class="btn btn-info btn-xs" title="Lihat"><i class="fas fa-eye"></i></a>
                                @if(Auth::user()->isAdmin() || Auth::user()->id === $item->petugas_id)
                                    <a href="{{ route('aspirasi.edit', $item->id) }}" class="btn btn-warning btn-xs" title="Edit"><i class="fas fa-edit"></i></a>
                                @endif
